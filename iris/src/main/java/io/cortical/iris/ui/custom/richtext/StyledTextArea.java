...
import org.fxmisc.richtext.SimpleEditableStyledDocument;
...
import io.cortical.iris.ui.custom.richtext.CssProperties.EditableProperty;
...
public class StyledTextArea<PS, S> extends Region
    ...
    /**
     * Returns the {@link VirtualFlow}
     * @return
     */
    public VirtualFlow<Paragraph<PS, S>, Cell<Paragraph<PS, S>, ParagraphBox<PS, S>>> getVirtualFlow() {
        return virtualFlow;
    }
    ...
    public StyledTextArea(PS initialParagraphStyle, BiConsumer<TextFlow, PS> applyParagraphStyle,
        ...
        getStylesheets().add(StyledTextArea.class.getClassLoader().getResource("styled-text-area.css").toExternalForm());
    ...
    private Cell<Paragraph<PS, S>, ParagraphBox<PS, S>> createCell(
        ...
        ParagraphBox<PS, S> box = new ParagraphBox<PS, S>(paragraph, applyParagraphStyle, applyStyle);
